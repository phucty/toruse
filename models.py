...
class BasicModel(object):
    def __init__(self, config, nent, nrel):
        ...
        self.emb_ent = tf.Variable(tf.random_uniform([nent, config.emb_dim], 0., 1.0), name="ent_emb")
        self.emb_rel = tf.Variable(tf.random_uniform([nrel, config.emb_dim], 0., 1.0), name="rel_emb")
